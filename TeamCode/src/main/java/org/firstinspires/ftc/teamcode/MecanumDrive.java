...
public final class MecanumDrive {
    public static class Params {
        ...
        public double inPerTick = 11.5/44200.0;// 0.0005281188056;
        public double lateralInPerTick = inPerTick;
        public double trackWidthTicks = 21490.133931577693;//1350877.628775391

        // feedforward parameters (in tick units)
        public double kS = 1.2266508349851595;
        public double kV = 0.00009743213468935042;
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "bottomLeft");
        rightBack = hardwareMap.get(DcMotorEx.class, "bottomRight");
